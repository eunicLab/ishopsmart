  ...
  return (
    <ScrollView>
      <Text style={styles.paragraph}>
        ...
        your personal information, please contact us at eunicLab.co@gmail.com.
      </Text>
      <Text style={styles.paragraph}>
      ...
      <Text style={styles.paragraph}>
        ...
        policy as the "Sites"). Please read this privacy policy
      </Text>
      <Text style={styles.paragraph}>
      ...
      <Text style={styles.mainHeading}>1. WHAT INFORMATION DO WE COLLECT?</Text>
      <Text style={styles.miniHeading}>
        Personal information you disclose to us
      </Text>
      <Text style={styles.paragraph}>
        We collect personal information that you voluntarily provide to us when
        registering at the Apps, expressing an interest in obtaining information
        about us or our products and services, when participating in activities
        on the Apps or otherwise contacting us.
      </Text>
      <Text style={styles.paragraph}>
      ...
      <Text style={styles.paragraph}>
        <Text style={styles.subHeading}>Name and Contact Data. </Text>
        <Text>
      ...
      <Text style={styles.paragraph}>
        ...
        <Text>
          ...
          processor directly to respond to your questions. All personal
      ...
      <Text style={styles.paragraph}>
        ...
        our Apps and other technical information. This information is primarily
        needed to maintain the security and operation of our Apps, and for our
      ...
      <Text style={styles.paragraph}>
        ...
        <Text>
          ...
          mobile device, including your mobile device’s storage, and other
          features. If you wish to change our access or permissions, you may do
          so in your device’s settings.
        </Text>
      </Text>
      <Text style={styles.paragraph}>
        <Text style={styles.subHeading}> Mobile Device Data. </Text>
        <Text>
      ...
      <Text style={styles.mainHeading}>2. HOW DO WE USE YOUR INFORMATION?</Text>
      <Text style={styles.paragraph}>
      ...
      <Text style={styles.paragraph}>
        <Text style={styles.subHeading}>Fulfill and manage your orders. </Text>{' '}
        <Text>
      ...
      <Text style={styles.paragraph}>
        <Text style={styles.subHeading}>Request Feedback.</Text>
        <Text>
      ...
      <Text style={styles.paragraph}>
        <Text style={styles.subHeading}>To protect our Sites. </Text>
        <Text>
          We may use your information as part of our efforts to keep our Apps
      ...
      <Text style={styles.paragraph}>
        <Text style={styles.subHeading}>For other Business Purposes. </Text>
        <Text>
      ...
      <Text style={styles.paragraph}>
        <Text style={styles.subHeading}>Legitimate Interests: </Text>
        <Text>
      ...
      <Text style={styles.paragraph}>
        <Text style={styles.subHeading}>Performance of a Contract: </Text>
        <Text>
      ...
      <Text style={styles.paragraph}>
        <Text style={styles.subHeading}>Legal Obligations: </Text>
        <Text>
      ...
      <Text style={styles.paragraph}>
        <Text style={styles.subHeading}>Vital Interests: </Text>
        <Text>
      ...
      <Text style={styles.paragraph}>
        ...
        <Text>
          ...
          visit the Apps. These companies may use information about your visits
          to our Website(s) and other websites that are contained in web cookies
          and other tracking technologies in order to provide advertisements
          about goods and services of interest to you.
        </Text>
      </Text>
      <Text style={styles.paragraph}>
        <Text style={styles.subHeading}>Affiliates. </Text>
        <Text>
      ...
      <Text style={styles.paragraph}>
        <Text style={styles.subHeading}>Business Partners. </Text>
        <Text>
      ...
      <Text style={styles.paragraph}>
        ...
        children under age 18, please contact us at eunicLab.co@gmail.com.
      </Text>
      <Text style={styles.mainHeading}>8. WHAT ARE YOUR PRIVACY RIGHTS?</Text>
      <Text style={styles.paragraph}>
      ...
      <Text style={styles.paragraph}>
        ...
        our active databases. However, some information may be retained in our
      ...
      <Text style={styles.paragraph}>
        ...
        Data Protection Officer (DPO), Eunice Nnaji, by email at
        eunicLab.co@gmail.com. If you are a resident in the European Economic
        Area, the "data controller" of your personal information is eunicLab.
        eunicLab has appointed Eunice Nnaji to be its representative in the EEA.
        You can contact them directly regarding the processing of your
        information by eunicLab, by email at eunicLab.co@gmail.com.
      </Text>
      <Text style={styles.subHeading}>Last updated July 09, 2020</Text>
    </ScrollView>
  );
};
